...
export class AppSettingsService {
  ...
  /**
   * Get the default landing page after sute selection from the app settings.
   * Default value: `/personal-files`.
   */
  get selectionLandingPage(): string {
    return this.appConfig.get<string>('selectionLandingPage', '/personal-files');
  }
}
