...
export class SetCurrentSiteAction implements Action {
  readonly type = AppActionTypes.SetCurrentSite;

  constructor(public payload: SiteState) {}
}

export class SetCurrentSiteGuidAction implements Action {
  readonly type = AppActionTypes.SetCurrentSiteGuid;
