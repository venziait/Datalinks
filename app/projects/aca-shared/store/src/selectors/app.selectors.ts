...
export const getSiteGuid = createSelector(selectApp, (state) => state.site.siteGuid);
export const getSiteId = createSelector(selectApp, (state) => state.site.site);
export const getSite = createSelector(selectApp, (state) => state.site);
export const getSiteInfo = createSelector(getSiteId, getSiteGuid, getUserProfile, (id, guid, profile) => {
  return {
    id,
    guid,
    profile
...
export const getRuleContext = createSelector(
  ...
  getRepositoryStatus,
  getSite,
  (selection, navigation, profile, repository, site) => ({
    selection,
    navigation,
    profile,
    repository,
